...
path('eliminarimagenresena/<int:pk>',views.eliminar_imagen_resena, name='eliminar_imagen_resena'),
...
path('eliminartodasimgresena/<int:pk>',views.eliminar_todas_imagen_resena, name='eliminar_todas_imagen_resena'),
path('buscar/', views.buscar_restaurantes, name='buscar_restaurantes')
]